...
final class AmbientWindDrift {
    ...
    /**
     * @return the wind-driven target horizontal velocity at the given Y in {@code level}, or
     *         {@code null} if the effect is disabled (0 intensity), wind hasn't synced for this
     *         dimension yet, or the elevation-adjusted strength there is 0.
     */
    static Vec3 targetVelocity(ClientLevel level, double y) {
        ...
        float strength = WindHeightScaling.scale(ClientWindState.strength(), y, level.getSeaLevel(),
